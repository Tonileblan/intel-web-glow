...
- **Instituciones y administraciones públicas**: seguridad para ayuntamientos, edificios públicos, instalaciones municipales, eventos y patrimonio, con mención a la experiencia trabajando para administraciones.
- **Particulares / Hogar**.
- **CCTV y videovigilancia**: incluyendo búsqueda inteligente de vídeo.
- **Obra nueva y renovaciones**.
- **Mantenimiento de sistemas**: contratos de mantenimiento preventivo y correctivo para empresas, comunidades, urbanizaciones e instituciones públicas (revisiones legales de PCI, alarmas, CCTV y control de acceso, tiempos de respuesta, 24h).
- **Blog / Centro de conocimiento**: artículos sobre los problemas reales de seguridad y control en empresas, instituciones y urbanizaciones, y sobre mantenimiento. Listado con filtros por categoría (empresas, instituciones, urbanizaciones, mantenimiento, normativa, videovigilancia), página de artículo con índice, tiempo de lectura, artículos relacionados y CTA de valoración gratuita, y feed RSS. Primer lote de artículos redactado desde cero, incluyendo: seguridad en ayuntamientos y edificios públicos; intrusión y robo en polígonos industriales; control de accesos y visitas en instalaciones sensibles; videovigilancia y RGPD/LOPDGDD; mantenimiento legal obligatorio de sistemas PCI; contratos de mantenimiento en urbanizaciones; vandalismo y control de zonas comunes; alarmas antiguas frente a sistemas conectados a CRA; seguridad en obra; cómo elegir empresa de seguridad certificada; falsas alarmas.
