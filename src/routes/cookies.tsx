        ...
        <div className="mx-auto max-w-3xl space-y-8 text-sm leading-relaxed text-muted-foreground">
          <div>
            ...
            <p className="mt-3">
              ...
              una web y que permite almacenar y recuperar información sobre la navegación.
            </p>
          </div>
          <div>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5">
              <li>
                Técnicas y necesarias: imprescindibles para que el sitio funcione y se
                muestre correctamente.
              </li>
              <li>
                Analíticas: si se activan, permiten conocer de forma agregada cómo se usa el
                sitio para mejorarlo. Solo se instalan con tu consentimiento.
              </li>
            </ul>
            <p className="mt-3">
              El listado detallado de cookies y proveedores se actualizará cuando se
              incorporen herramientas de analítica o marketing a este sitio.
            </p>
          </div>
          <div>
            <h2 className="text-xl font-medium text-foreground">
              Cómo gestionarlas o eliminarlas
            </h2>
            <p className="mt-3">
              Puedes permitir, bloquear o eliminar las cookies instaladas desde la
              configuración de tu navegador (Chrome, Safari, Firefox o Edge). Bloquear las
          ...
          <div>
            ...
            <p className="mt-3">
              Si tienes cualquier consulta sobre esta política, escríbenos a {site.email} o
