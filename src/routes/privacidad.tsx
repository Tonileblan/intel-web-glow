    ...
    <>
      ...
      <section className="px-6 py-16">
        <div className="mx-auto max-w-3xl space-y-8 text-sm leading-relaxed text-muted-foreground">
          ...
          <div>
            <h2 className="text-xl font-medium text-foreground">Finalidades del tratamiento</h2>
            <ul className="mt-3 list-disc space-y-2 pl-5">
              ...
              <li>
                Enviar comunicaciones sobre nuestros servicios, cuando exista consentimiento o
                interés legítimo.
              </li>
            </ul>
          </div>
          <div>
            ...
            <p className="mt-3">
              El consentimiento del interesado, la ejecución de un contrato o precontractual, el
              cumplimiento de obligaciones legales y el interés legítimo del responsable, según cada
              finalidad.
            </p>
          </div>
          <div>
            ...
            <p className="mt-3">
              Los datos se conservan mientras se mantenga la relación y, después, durante los plazos
              legales de prescripción de responsabilidades. Las imágenes de sistemas de
              videovigilancia se conservan por el plazo legalmente previsto, salvo que deban
              mantenerse para acreditar un hecho.
            </p>
          </div>
          <div>
            <h2 className="text-xl font-medium text-foreground">Destinatarios</h2>
            <p className="mt-3">
              No se ceden datos a terceros salvo obligación legal o cuando sea necesario para
              prestar el servicio (por ejemplo, central receptora de alarmas o proveedores
          ...
          <div>
            ...
            <p className="mt-3">
              ...
              portabilidad y oposición escribiendo a {site.email}, acreditando tu identidad. También
